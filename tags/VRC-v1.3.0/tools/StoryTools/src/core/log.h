...
#define log_out         beditor::beditorlog
#define log_verbose     beditor::beditorlog << beditor::Log::LogLevel( beditor::Log::L_VERBOSE )
#define log_debug       beditor::beditorlog << beditor::Log::LogLevel( beditor::Log::L_DEBUG   )
#define log_error       beditor::beditorlog << beditor::Log::LogLevel( beditor::Log::L_ERROR   )
#define log_warning     beditor::beditorlog << beditor::Log::LogLevel( beditor::Log::L_WARNING )
#define log_info        beditor::beditorlog << beditor::Log::LogLevel( beditor::Log::L_INFO    )
