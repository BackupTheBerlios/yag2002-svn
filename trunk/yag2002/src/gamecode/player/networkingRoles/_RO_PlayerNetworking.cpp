...
value1
_RO_DO_MEMBERFUNC_CRACK_END2()
_RO_DO_MEMBERFUNC_PRESTAGE_DEF(PlayerNetworking,RPC_EnableVoiceChat)
bool value1
...
bool value1;
_RO_DO_MEMBERFUNC_MESSAGE_CRACK(value1)
_RO_DO_MEMBERFUNC_CRACK_END(PlayerNetworking,RPC_EnableVoiceChat)
value1
_RO_DO_MEMBERFUNC_CRACK_END2()
...
_RO_DO_REGISTERBLOCK_PREDICT_FLOAT_SETMINDISTANCE(0.2f)
...
_RO_DO_DATABLOCK_SETUPDATEDELAYMINIMUM(0.3f)
...
_RO_DO_DATABLOCK_MAKERELIABLE()
_RO_DO_REGISTERBLOCK_END()
_RO_DO_REGISTERBLOCK_NDATA_VAR(_voiceChat)
_RO_DO_DATABLOCK_MAKERELIABLE()
_RO_DO_REGISTERBLOCK_END()
_RO_DO_REGISTERBLOCK_NDATA_VAR(_ip)
_RO_DO_DATABLOCK_MAKERELIABLE()
_RO_DO_REGISTERBLOCK_END()
