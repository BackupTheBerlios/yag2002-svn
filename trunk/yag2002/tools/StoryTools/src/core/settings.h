...
//! Tool setting profile
#define CFG_PROFILE                 "cfg"

//! Convenient macros for setting/getting tool configuration tokens
#define CFG_GET_VALUE( token, value )      SettingsManager::get()->getProfile( CFG_PROFILE )->getValue( token, value )
#define CFG_SET_VALUE( token, value )      SettingsManager::get()->getProfile( CFG_PROFILE )->setValue( token, value )
...
class Settings
{
    ...
    protected:
        ...
        bool                                    write( const std::string& token, const Eigen::Vector3f& value );
        ...
        bool                                    read( const std::string& token, Eigen::Vector3f& value );
