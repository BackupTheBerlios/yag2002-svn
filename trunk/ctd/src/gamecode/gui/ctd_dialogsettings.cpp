...
void DialogGameSettings::setupControls()
{
    ...
    //-----------------------------------
    {
        ...
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_PLAYER_NAME, cfg_playername );
        // set player name
    ...
    // get network settings
    {
        ...
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_SERVER_NAME, cfg_servername );
        std::string cfg_serverip;
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_SERVER_IP, cfg_serverip );
        unsigned int cfg_serverport;
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_SERVER_PORT, cfg_serverport );
    ...
    // get key bindings
    {
        ...
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_MOUSESENS, cfg_mousesensitivity );
        bool   cfg_mouseInverted;
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_INVERTMOUSE, cfg_mouseInverted );
    ...
    // get keyboard settings
    {
        ...
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_KEYBOARD, cfg_keyboard );
    ...
    {
        bool fullscreen;
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_FULLSCREEN, fullscreen );
        if ( fullscreen )
        {
        ...
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_SCREENWIDTH, width );
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_SCREENHEIGHT, height );
        yaf3d::Configuration::get()->getSettingValue( CTD_GS_COLORBITS, colorbits );
...
bool DialogGameSettings::onClickedOk( const CEGUI::EventArgs& arg )
{
    ...
    // set key bindings
    {
        ...
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_KEY_MOVE_FORWARD, cfg_key );

        cfg_key = _p_keyMoveBackward->getText().c_str();
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_KEY_MOVE_BACKWARD, cfg_key );

        cfg_key = _p_keyMoveLeft->getText().c_str();
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_KEY_MOVE_LEFT, cfg_key );

        cfg_key = _p_keyMoveRight->getText().c_str();
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_KEY_MOVE_RIGHT, cfg_key );

        cfg_key = _p_keyJump->getText().c_str();
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_KEY_JUMP, cfg_key );

        cfg_key = _p_keyCameraMode->getText().c_str();
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_KEY_CAMERAMODE, cfg_key );

        cfg_key = _p_keyChatMode->getText().c_str();
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_KEY_CHATMODE, cfg_key );
    }

    // set mouse settings
    {
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_MOUSESENS, _mouseSensitivity );    
        bool mouseInvert  = _p_mouseInvert->isSelected();
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_INVERTMOUSE, mouseInvert );
    }

    // set server settings
    {
        std::string servername = _p_serverName->getText().c_str();
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_SERVER_NAME, servername );

        std::string serverip   = _p_serverIP->getText().c_str();
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_SERVER_IP, serverip );

        std::stringstream portasstring;
        portasstring << _p_serverPort->getText().c_str();
        unsigned int serverport = 0;
        portasstring >> serverport;
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_SERVER_PORT, serverport );
    }
    ...
    // set keyboard type
    {
        ...
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_KEYBOARD, cfg_keyboard );
    }

    // set the display setting
    {
        bool fullscreen = _p_fullscreen->isSelected();
        yaf3d::Configuration::get()->setSettingValue( CTD_GS_FULLSCREEN, fullscreen );
        if ( !fullscreen )
        {
            unsigned int width, height, colorbits;
            ...
            yaf3d::Configuration::get()->setSettingValue( CTD_GS_SCREENWIDTH, width );
            yaf3d::Configuration::get()->setSettingValue( CTD_GS_SCREENHEIGHT, height );
            yaf3d::Configuration::get()->setSettingValue( CTD_GS_COLORBITS, colorbits );
        }
    }
