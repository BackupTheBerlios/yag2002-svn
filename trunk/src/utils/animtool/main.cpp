...
void PrintHelp()
{
    ...
    printf(
            ...
            "\n"
            "frame manipulation\n"
            "  -beginFrame < frame index >    default is begin of the animation\n"
            "  -endFrame < frame index >      default is end of the whole animation\n"
            "  -deleteFrames                  delete frames from track, define the frames using -begin_frame and -end_frame\n"
            "  -trackLength < time >          new track length in seconds\n"
            "\n"
            "translation\n"
