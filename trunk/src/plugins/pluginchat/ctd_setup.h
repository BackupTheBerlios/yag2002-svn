...
// levelset related helper functions
class CTD::LevelSet;
extern CTD::LevelSet* s_pkLevelSet;
void SetLevelSet( CTD::LevelSet* pkLevelSet );
CTD::LevelSet* GetLevelSet();

// input processing stuff
//------------------------------------------//
#define  CTD_KEYFLAG_ARRAY_NUM	    14
